...
public class RouteFinder {
	...
	public void getRoutesFromWeb(){
		...
		Call<Response> queryResponseCall = service.requestRoutes(r.getTo(), r.getRouteType(), r.getResultsNumber(), r.getDepartureTime(), r.getFrom(), r.getDate(), r.getTransportTypes());
	...
	public interface RequestRoutes {
		@POST("bologna.mobility/plansinglejourney?policyId=Trento")
		Call<Response> requestRoutes(@Query("to") To to,
								   @Query("routeType") String routeType,
								   @Query("resultsNumber") int resultsNumber,
								   @Query("departureTime") String departureTime,
								   @Query("from") From from,
								   @Query("date") String date,
								   @Query("transportTypes") List<String> transportTypes);
	}
}
